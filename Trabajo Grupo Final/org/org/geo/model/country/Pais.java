...
public class Pais extends GeographicalArea implements Cloneable, Comparable<Pais> {
	...
	private List<Pais> neighbours = new ArrayList<Pais>();
	...
	public void setNeighbours(List<Pais> neighbours) {

		List<Integer> listIndex = new ArrayList<Integer>();

		for (int i = 0; i < neighbours.size(); i++) {

			Pais country = neighbours.get(i);
	...
	public boolean addNeighbour(Pais country) {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		if (this.getContinent() != null) {
			other.setContinent((Continente) this.getContinent().clone());
		} else {
		...
		if (this.getNeighbours() != null) {
			for (Pais country : this.getNeighbours()) {
				other.addNeighbour((Pais) country.clone());
			}
		}
		if (this.getNeighbours() != null) {
